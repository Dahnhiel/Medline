        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="font-dm-sans text-sm leading-relaxed text-teal-100/70">
              Providing licensed and board-certified medical evaluations that
              ensure your organization remains safe, healthy, and compliant with
            ...
            <div className="flex gap-4">
              {["facebook-f", "linkedin-in", "twitter"].map((icon) => (
                <a
                  key={icon}
                  href="#"
                  className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/60 hover:bg-[#0B6E6E] hover:text-white hover:border-[#0B6E6E] transition-all duration-300"
                >
            ...
            <ul className="space-y-3">
              {quickLinks.map(({ to, label }) => (
                <li key={to}>
                  <Link
                    to={to}
                    className="group flex items-center text-sm text-teal-100/70 hover:text-white transition-colors"
                  >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {medicalServices.map((service) => (
                <li
                  key={service}
                  className="flex items-start gap-2 text-sm text-teal-100/70"
                >
          ...
          <div>
            ...
            <div className="space-y-6">
              <a href="tel:4044646925" className="group flex items-start gap-4">
                ...
                <div>
                  <p className="text-[0.65rem] uppercase font-bold text-teal-500">
                    Call Us
                  </p>
              ...
              <a
                href="mailto:medlinehsllc@gmail.com"
      ...
      <div className="border-t border-white/5 py-8">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-teal-100/40 font-dm-sans text-center">
            © {new Date().getFullYear()} Medline Health Services, LLC. All
            rights reserved.
          ...
          <div className="flex gap-6 items-center">
            <span className="text-[10px] font-bold text-teal-100/20 tracking-[0.3em] uppercase">
              HIPAA COMPLIANT
            </span>
            <span className="text-[10px] font-bold text-teal-100/20 tracking-[0.3em] uppercase">
              BOARD CERTIFIED
